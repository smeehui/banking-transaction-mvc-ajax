...
public class CustomerServiceImpl implements ICustomerService {
    ...
    @Autowired
    private LocationReigionRepository locationReigionRepository;
    ...
    @Override
    public List<CustomerDTO> findAllCustomerDTOsByDeletedIsFalse() {
        return customerRepository.findAllCustomerDTOsByDeletedIsFalse();
    }

    public Optional<Customer> findByIdAndDeleteIsFalse(Long id) {
