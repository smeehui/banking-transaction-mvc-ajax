...
//    public String doTransfer(@PathVariable Long senderId, @ModelAttribute TransferDTO transferDTO, BindingResult bindingResult, Model model) {
//
...
//        }
//
//        Long recipientId = transferDTO.getRecipient().getId();
//
...
//        transferDTO.setTransactionAmount(null);
//
//        model.addAttribute("transferDTO", transferDTO);
//
//        model.addAttribute("success", true);
